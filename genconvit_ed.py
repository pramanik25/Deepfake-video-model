...
class GenConViTED(nn.Module):
    def __init__(self, config, pretrained=True):
        ...
        self.backbone = timm.create_model(config.get("model", {}).get("backbone", {}), pretrained=pretrained)

        self.embedder = timm.create_model(config.get("model", {}).get("embedder", {}), pretrained=pretrained)
